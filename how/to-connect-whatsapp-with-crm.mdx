...
<Frame>
  <img src="/how/int1.png" alt="WhatsApp integration in the Integrations section" className="rounded-lg" />
</Frame>
---
...
<Frame>
  <img src="/how/int2.png" alt="WhatsApp integration settings, with the keys and webhook your CRM needs" className="rounded-lg" />
</Frame>
