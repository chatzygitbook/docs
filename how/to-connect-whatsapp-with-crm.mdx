...
<Frame>
  <img src="/how/int1.png" alt="WhatsApp integration card in the Integrations section" className="rounded-lg" />
</Frame>
---
...
<Frame>
  <img src="/how/int2.png" alt="WhatsApp integration key settings: API endpoint, API key and webhook setup" className="rounded-lg" />
</Frame>
