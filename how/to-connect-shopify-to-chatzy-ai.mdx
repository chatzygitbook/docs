...
<Frame>
  <img src="./shopify/1.png" alt="Shopify listed as a channel in Chatzy" className="rounded-lg" />
</Frame>

Click **Install on Shopify**.

<Frame>
  <img src="./shopify/2.png" alt="Starting the Chatzy install from the Shopify channel page" className="rounded-lg" />
</Frame>
...
<Frame>
  <img src="./shopify/3.jpg" alt="Chatzy AI listing in the Shopify App Store" className="rounded-lg" />
</Frame>
...
<Frame>
  <img src="./shopify/4.png" alt="Shopify asking you to confirm the app's permissions" className="rounded-lg" />
</Frame>
...
<Frame>
  <img src="./shopify/5.png" alt="Chatzy setup page inside Shopify, before the account is connected" className="rounded-lg" />
</Frame>
...
<Frame>
  <img src="./shopify/6.jpg" alt="Chatzy setup page inside Shopify once the store is connected" className="rounded-lg" />
</Frame>
...
<Frame>
  <img src="./shopify/7.jpg" alt="Shopify source in the agent's Data tab, listing what has been trained" className="rounded-lg" />
</Frame>
...
<Frame>
  <img src="./shopify/8.jpg" alt="Chat Widget settings for the store's agent, with a live preview" className="rounded-lg" />
</Frame>
...
<Frame>
  <img src="./shopify/9.png" alt="Shopify storefront with the Chatzy chat bubble in the corner" className="rounded-lg" />
</Frame>
...
<Frame>
  <img src="./shopify/10.jpg" alt="Widget open on the storefront, offering product questions to start with" className="rounded-lg" />
</Frame>
