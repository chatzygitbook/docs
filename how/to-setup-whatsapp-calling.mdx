...
<Frame>
  <img src="/how/wacall1.png" alt="Turning on WhatsApp calling and setting the hours it is available" className="rounded-lg" />
</Frame>
...
<Frame>
  <img src="/how/wacall3.png" alt="Starting a journey from an incoming call" className="rounded-lg" />
</Frame>

4. Add an action → select **Assign to Voice AI Agent**.  
<Frame>
  <img src="/how/wacall4.png" alt="Handing an incoming call to a voice agent" className="rounded-lg" />
</Frame>

5. Open the settings of the action. Select the **Voice AI Agent** from the dropdown.  
<Frame>
  <img src="/how/wacall5.png" alt="Choosing which voice agent answers the call" className="rounded-lg" />
</Frame>
...
<Frame>
  <img src="/how/wacall2.png" alt="Building a WhatsApp template that asks permission to call" className="rounded-lg" />
</Frame>
...
<Frame>
  <img src="/how/wacall6.png" alt="Journey action that calls a contact with a voice agent" className="rounded-lg" />
</Frame> 
