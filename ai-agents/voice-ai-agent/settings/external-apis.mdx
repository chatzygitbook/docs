...
<Frame>
  <img src="/ai-agents/voice-ai-agent/settings/external-apis.png" alt="External APIs tab for adding an API the voice agent can call" />
</Frame>
...
### What each External API field means

Every external API you add is configured with the following fields.
