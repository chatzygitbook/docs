...
<Frame>
  <img src="/ai-agents/flow-based-ai-agent/studio/execute.png" alt="Execute menu for choosing what the flow should run"  />
</Frame>
---
...
> ```
<Frame>
  <img src="/ai-agents/flow-based-ai-agent/studio/code.png" alt="Execute card running custom code, with its result below"  />
</Frame>
---
...
<Frame>
  <img src="/ai-agents/flow-based-ai-agent/studio/aitask.png" alt="Execute card set to run a one-off AI task"  />
</Frame>
---
...
<Frame>
  <img src="/ai-agents/flow-based-ai-agent/studio/query.png" alt="Execute card set to ask a conversational agent a question"  />
</Frame>
---
