...
<Frame>
  <img src="/ai-agents/flow-based-ai-agent/studio/show-messages.png" alt="Show Messages menu for choosing a message type"  />
</Frame>
...
<Frame>
  <img src="/ai-agents/flow-based-ai-agent/studio/text.png" alt="Show Message card set to send text"  />
</Frame>
---
...
<Frame>
  <img src="/ai-agents/flow-based-ai-agent/studio/document.png" alt="Show Message card set to send a document"  />
</Frame>
---
...
<Frame>
  <img src="/ai-agents/flow-based-ai-agent/studio/card.png" alt="Card message settings in the flow studio"  />
</Frame>
> **Example 2:**  
> - **Title:** iPhone 15 Pro  
...
<Frame>
  <img src="/ai-agents/flow-based-ai-agent/studio/button.png" alt="Button Card Configuration" />
</Frame>
...
<Frame>
  <img src="/ai-agents/flow-based-ai-agent/studio/button2.png" alt="WhatsApp Call Button Configuration" />
</Frame>
...
<Frame>
  <img src="/ai-agents/flow-based-ai-agent/studio/action.png" alt="Show Message card set to send a button that triggers an action"  />
</Frame>