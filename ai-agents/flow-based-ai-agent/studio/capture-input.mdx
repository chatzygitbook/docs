...
<Frame>
  ![Capture Input menu for choosing how to collect information from the user](/ai-agents/flow-based-ai-agent/studio/capture-input.png)
</Frame>
...
<Frame>
  <img src="/ai-agents/flow-based-ai-agent/studio/raw.png" alt="Capture Input card set to collect a free-text answer"  />
</Frame>
...
<Frame>
  <img src="/ai-agents/flow-based-ai-agent/studio/single-choice.png" alt="Capture Input card set to offer a single choice"  />
</Frame>
...
- **Store in variable**: Saves the user's selections in a variable.
  ...
  <Frame>
  <img src="/ai-agents/flow-based-ai-agent/studio/multiple-choice.png" alt="Capture Input card set to offer multiple choices"  />
  </Frame>
---
...
<Frame>
  <img src="/ai-agents/flow-based-ai-agent/studio/dropdown.png" alt="Capture Input card set to offer a dropdown of choices"  />
</Frame>
---
...
- **Question to ask**: The message the user will see.
<Frame>
  <img src="/ai-agents/flow-based-ai-agent/studio/image-ver.png" alt="Capture Input card set to collect an image or document"  />
</Frame>
---
...
<Frame>
  <img src="/ai-agents/flow-based-ai-agent/studio/location.png" alt="Capture Input card set to collect a location"  />
</Frame>
