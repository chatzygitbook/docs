...
<Frame>
  <img src="/ai-agents/squads/squad1.png" alt="Network squad, where agents hand off to one another directly" />
</Frame>
---

**Supervisor** 
<Frame>
  <img src="/ai-agents/squads/squad3.png" alt="Supervisor squad, where a starting agent routes work to the others" />
</Frame>
---

**Custom**
<Frame>
  <img src="/ai-agents/squads/squad2.png" alt="Custom squad, mixing persistent and transient agents" />
</Frame>




### The three Squad architectures compared

Each architecture decides how the agents in a Squad talk to each other.
...
<Columns cols={2}>
  <Frame>
    <img src="/ai-agents/squads/prompt1.png" alt="Base Prompt tab for the sales agent, showing the conditions that transfer a conversation to the support agent" className="rounded-lg" />
  </Frame>
  <Frame>
    <img src="/ai-agents/squads/prompt2.png" alt="Base Prompt tab for the support agent, showing the conditions that transfer the conversation back" className="rounded-lg" />
  </Frame>
</Columns>
...
<Frame>
  <img src="/ai-agents/squads/overview.png" alt="Squads screen listing the squads you have created" />
</Frame>
<Frame>
  <img src="/ai-agents/squads/overview2.png" alt="Chat Logs tab of a squad, filtered by date range" />
</Frame>
