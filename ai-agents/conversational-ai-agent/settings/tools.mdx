The **Tools** tab allows your Conversational AI Agent to trigger journey and schedule appointments directly from conversations.

<Frame>
  <img src="/ai-agents/conversational-ai-agent/settings/tools.png" alt="Tools tab for giving the agent actions it can take" />
</Frame>
...
The **Trigger Journey** feature allows your Conversational AI Agent to automatically trigger a Journey when specific conditions are met during a conversation.
