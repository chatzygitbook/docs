...
> Example :- When the customer confirms appointment, call the function `workflow_trigger` these details:
...
- **Additional Settings**  
  - **Get Contact Details** → Retrieve all information associated with a contact. This includes:

    Basic details: email, phone, name, contact_id, ifram_user_id
