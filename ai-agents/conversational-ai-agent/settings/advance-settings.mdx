...
- **Add Historical Context**  
  ...
  - **Historical Context Length**: Number of previous messages included in the search.  
    Example: Setting `2` means the AI considers the latest user query + the previous assistant response.  
