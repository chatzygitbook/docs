...
- **Entities**: This is where you define what information you want to extract from the user's conversation.
  - **Entity name**: The name of the variable where the extracted data will be saved (e.g., `user_address`, `meeting_date`, `user_email`) this isn't a part work flow variables.
