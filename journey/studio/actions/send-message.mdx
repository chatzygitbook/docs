...
The **Send Message** action is used to send a one-way, outbound message to a user. This is a key action for proactive communication, allowing you to send notifications, reminders, or follow-ups to a contact, even if a conversation is not active.
