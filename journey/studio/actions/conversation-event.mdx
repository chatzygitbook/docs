...
<Frame>
  <img src="/journey/studio/actions/convention-event1.png" alt="Conversion Event action for reporting an event back to Meta" className="rounded-lg" />
</Frame>
...
<Frame>
  <img src="/journey/studio/actions/convention-event2.png" alt="Conversion Event action with extra parameters added to the event" className="rounded-lg" />
</Frame>
