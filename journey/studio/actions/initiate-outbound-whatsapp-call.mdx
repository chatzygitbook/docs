...
<Frame>
  <img src="/journey/studio/actions/initiate-outbound-whatsapp-call.png" alt="Initiate Outbound WhatsApp Call action for calling a contact" className="rounded-lg" />
</Frame>
