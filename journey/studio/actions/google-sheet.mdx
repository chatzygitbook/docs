...
<Frame>
  <img src="/journey/studio/actions/google-sheet1.png" className="rounded-lg" />
</Frame>

Once connected, choose the desired **Action Type**.

<Frame>
  <img src="/journey/studio/actions/google-sheet2.png" className="rounded-lg" />
</Frame>
...
<Frame>
  <img src="/journey/studio/actions/google-sheet3.png" className="rounded-lg" />
</Frame>
...
<Frame>
  <img src="/journey/studio/actions/google-sheet4.png" className="rounded-lg" />
</Frame>
