...
<Columns cols={2}>
<Frame>
  <img src="/journey/studio/actions/wait-until.png" alt="Wait Until action panel in the journey builder" className="rounded-lg" />
</Frame>
<Frame>
  <img src="/journey/studio/actions/wait-until2.png" alt="Wait Until action set to wait for an external event" className="rounded-lg" />
</Frame>
</Columns>
...
<Frame>
  <img src="/journey/studio/actions/wait-until-eg.png" alt="Journey using Wait Until between a webhook and a message" className="rounded-lg" />
</Frame>
...
<Frame>
  <img src="/journey/studio/actions/wait-until-wh.png" alt="Wait Until action set to resume only inside working hours" className="rounded-lg" />
</Frame>
Here’s how it works:
