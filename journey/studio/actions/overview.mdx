...
<Columns cols={1}>
  ...
  ---
> **Instruction:**  
> If you want to send a **direct message** to a user when there’s no open conversation window, use the **Send Message** action.  
> If the user already has an active **24-hour conversation window**, then use the **Send Message in Conversation** action instead.
---
