...
<Frame>
  <img src="/journey/runs.png" alt="Journey Runs list for reviewing each execution of a journey" className="rounded-lg" />
</Frame>
...
<Columns cols={2}>
<Frame>
  <img src="/journey/runs3.png" alt="Steps Completed panel showing the steps a journey run executed" className="rounded-lg" />
</Frame>
<Frame>
  <img src="/journey/runs2.png" alt="Steps Completed panel showing a journey run that ended in an error" className="rounded-lg" />
</Frame>
