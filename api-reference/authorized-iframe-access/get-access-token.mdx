...
The `client_api_key` is your **AI Agent Auth Key**. It is issued only by [Generate AI Agent Auth Key](/api-reference/authorized-iframe-access/generate-ai-agent-auth-key) and is shown once, at generation time — there is no page to look it up on later. If you don't have it, regenerate it there.
